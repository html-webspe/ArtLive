(() => {
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".tour-team__slider")) new core(".tour-team__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                breakpoints: {
            ...
            if (document.querySelector(".tour-reviews__slider")) new core(".tour-reviews__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                navigation: {
                    prevEl: ".tour-reviews__button-prev",
                    nextEl: ".tour-reviews__button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
