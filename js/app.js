    ...
    (() => {
        ...
        function rangeInit() {
            ...
            if (priceSlider) {
                ...
                var snapValues = [ document.getElementById("min"), document.getElementById("max") ];
        ...
        function initSliders() {
            if (document.querySelector(".product")) new core(".product", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                navigation: {
            ...
            if (document.querySelector(".tour-preview__slider")) new core(".tour-preview__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                navigation: {
                    prevEl: ".tour-preview__button-prev",
                    nextEl: ".tour-preview__button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 3,
            ...
            if (document.querySelector(".tour-info__slider")) new core(".tour-info__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                navigation: {
                    prevEl: ".tour-info__button-prev",
                    nextEl: ".tour-info__button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".tour-info__team-slider")) new core(".tour-info__team-slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                breakpoints: {
            ...
            if (document.querySelector(".tour-info__reviews-slider")) new core(".tour-info__reviews-slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                navigation: {
                    prevEl: ".tour-info__reviews-button-prev",
                    nextEl: ".tour-info__reviews-button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
        ...
        da.init();
        const filterDetailBtn = document.querySelector(".filter__item-detail"), filterItemButton = document.querySelectorAll(".button-js"), filterItem = document.querySelectorAll(".filter__item"), setRatingComfort = document.getElementById("set_rating-сomfort"), setRatingActivity = document.getElementById("set_rating-activity");
        if (filterItemButton) {
            filterItemButton.forEach((el => {
                el.addEventListener("click", (function(e) {
                    ...
                    if (!this.closest(".filter__item").classList.contains("filter__item-open")) {
                        filterItem.forEach((element => {
                            element.classList.remove("filter__item-open");
                            element.querySelector(".dropdown-filter").setAttribute("hidden", "true");
                        }));
                        this.closest(".filter__item").classList.add("filter__item-open");
                        _slideDown(this.closest(".filter__item").querySelector(".dropdown-filter"), 150);
                    } else {
                        this.closest(".filter__item").classList.remove("filter__item-open");
                        _slideUp(this.closest(".filter__item").querySelector(".dropdown-filter"), 150);
                    }
                }));
            }));
            document.addEventListener("click", (function(e) {
        ...
        if (filterDetailBtn) filterDetailBtn.addEventListener("click", (function(e) {
            ...
            this.closest(".filter").classList.toggle("filter-open");
        }));
        const currencyItem = document.querySelectorAll(".filter-price__currency-item");
        if (currencyItem) currencyItem.forEach((element => {
            element.addEventListener("click", (function(e) {
                currencyItem.forEach((el => {
                    el.classList.remove("filter-price__currency-current");
                }));
                if (!element.classList.contains("filter-price__currency-current")) element.classList.add("filter-price__currency-current"); else element.classList.remove("filter-price__currency-current");
            }));
        }));
        window["FLS"] = true;
        isWebp();
